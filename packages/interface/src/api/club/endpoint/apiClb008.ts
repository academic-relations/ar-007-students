import { ClubRepresentativeEnum } from "@sparcs-students/interface/common/enum/club.enum";
import { zKrPhoneNumber } from "@sparcs-students/interface/common/type/phoneNumber.type";
...
const url = () =>
  `/student/students/club/{clubId}/representatives/representative/{representativeId}/candidates`;
const method = "GET";
